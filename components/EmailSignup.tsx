    ...
    <form onSubmit={handleSubmit} className="mt-8 lg:mt-10 max-w-2xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <select
          ...
          className={`px-4 py-3.5 lg:py-4 rounded-lg bg-white border-0 focus:ring-2 focus:ring-brand-gold outline-none shadow-lg sm:w-48 lg:w-52 text-base cursor-pointer ${origin ? "text-gray-900" : "text-gray-400"}`}
        >
